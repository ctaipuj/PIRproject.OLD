...
if("TRUE" STREQUAL "TRUE")
  set(rgbd_depth_correction_SOURCE_PREFIX /home/ctai/catkin_ws2/src/industrial_calibration/rgbd_depth_correction)
  set(rgbd_depth_correction_DEVEL_PREFIX /home/ctai/catkin_ws2/devel/.private/rgbd_depth_correction)
  ...
  set(rgbd_depth_correction_INSTALL_PREFIX /home/ctai/catkin_ws2/install)
...
if(NOT "/usr/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rgbd_depth_correction' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ctai/catkin_ws2/src/industrial_calibration/rgbd_depth_correction/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rgbd_depth_correction_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/libceres.so.1.12.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ctai/catkin_ws2/devel/.private/rgbd_depth_correction/lib;/home/ctai/catkin_ws2/devel/lib;/opt/ros/kinetic/lib)
