...
if("TRUE" STREQUAL "TRUE")
  set(robo_cylinder_SOURCE_PREFIX /home/ctai/catkin_ws2/src/intelligent_actuator/robo_cylinder)
  set(robo_cylinder_DEVEL_PREFIX /home/ctai/catkin_ws2/devel/.private/robo_cylinder)
  ...
  set(robo_cylinder_INSTALL_PREFIX /home/ctai/catkin_ws2/install)
...
if(NOT "/home/ctai/catkin_ws2/devel/.private/robo_cylinder/include " STREQUAL " ")
  set(robo_cylinder_INCLUDE_DIRS "")
  set(_include_dirs "/home/ctai/catkin_ws2/devel/.private/robo_cylinder/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robo_cylinder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ctai/catkin_ws2/src/intelligent_actuator/robo_cylinder/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ctai/catkin_ws2/devel/.private/robo_cylinder/lib;/home/ctai/catkin_ws2/devel/lib;/opt/ros/kinetic/lib)
