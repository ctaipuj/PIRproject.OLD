...
if("TRUE" STREQUAL "TRUE")
  set(target_finder_SOURCE_PREFIX /home/ctai/catkin_ws2/src/industrial_calibration/target_finder)
  set(target_finder_DEVEL_PREFIX /home/ctai/catkin_ws2/devel/.private/target_finder)
  ...
  set(target_finder_INSTALL_PREFIX /home/ctai/catkin_ws2/install)
...
if(NOT "/home/ctai/catkin_ws2/devel/.private/target_finder/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(target_finder_INCLUDE_DIRS "")
  set(_include_dirs "/home/ctai/catkin_ws2/devel/.private/target_finder/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'target_finder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ctai/catkin_ws2/src/industrial_calibration/target_finder/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ctai/catkin_ws2/devel/.private/target_finder/lib;/home/ctai/catkin_ws2/devel/lib;/opt/ros/kinetic/lib)
