...
if("TRUE" STREQUAL "TRUE")
  set(industrial_extrinsic_cal_SOURCE_PREFIX /home/ctai/catkin_ws2/src/industrial_calibration/industrial_extrinsic_cal)
  set(industrial_extrinsic_cal_DEVEL_PREFIX /home/ctai/catkin_ws2/devel/.private/industrial_extrinsic_cal)
  ...
  set(industrial_extrinsic_cal_INSTALL_PREFIX /home/ctai/catkin_ws2/install)
...
if(NOT "/home/ctai/catkin_ws2/devel/.private/industrial_extrinsic_cal/include;/home/ctai/catkin_ws2/src/industrial_calibration/industrial_extrinsic_cal/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(industrial_extrinsic_cal_INCLUDE_DIRS "")
  set(_include_dirs "/home/ctai/catkin_ws2/devel/.private/industrial_extrinsic_cal/include;/home/ctai/catkin_ws2/src/industrial_calibration/industrial_extrinsic_cal/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_extrinsic_cal' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ctai/catkin_ws2/src/industrial_calibration/industrial_extrinsic_cal/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ctai/catkin_ws2/devel/.private/industrial_extrinsic_cal/lib;/home/ctai/catkin_ws2/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "actionlib;actionlib_msgs;cv_bridge;geometry_msgs;image_transport;message_runtime;moveit_ros_planning_interface;rosconsole;roscpp;roslib;roslint;sensor_msgs;std_msgs;std_srvs;tf;tf_conversions")
