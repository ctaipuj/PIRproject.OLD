...
vector<vector<double> > space::getgeometrydata(vector<vector<double> > kinect_xyz, vector<vector<cv::Point> > contornos, int bottle_type, double fx,double fy){//OJO AL Z A VER SI ES NECESARIO ENVIAR EL DATO.
